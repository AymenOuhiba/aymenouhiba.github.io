...
const I18N = {
  en: {
    ...
    hero: {
      eyebrow: 'AI Engineer',
      intro: 'AI Engineer graduated from Telecom Paris, Microsoft Azure AI Apps and Agents Developer certified (AI-103), specialized in LLMs, RAG pipelines, and LangGraph agents on Azure with 3+ years delivering production AI systems.',
      tag1: 'Azure AI Apps and Agents Developer Associate (AI-103)',
      tag2: 'Agentic AI',
      tag3: 'Paris, France',
    ...
    about: {
      ...
      text: 'AI Engineer graduated from Telecom Paris and certified Microsoft Azure AI Apps and Agents Developer (AI-103). I specialize in LLMs, RAG pipelines, and LangGraph agents on Azure, with 3+ years building production AI systems.',
      badge1: 'Microsoft Certified: Azure AI Apps and Agents Developer Associate (AI-103)',
  ...
  fr: {
    ...
    hero: {
      ...
      intro: 'Ingenieur IA diplome de Telecom Paris, certifie Microsoft Azure AI Apps and Agents Developer (AI-103), specialise dans les LLM, les pipelines RAG et les agents LangGraph sur Azure, avec plus de 3 ans d\'experience en production.',
      tag1: 'Azure AI Apps and Agents Developer Associate (AI-103)',
      tag2: 'Agentic AI',
      tag3: 'Paris, France',
    ...
    about: {
      ...
      text: 'Ingenieur IA diplome de Telecom Paris et certifie Microsoft Azure AI Apps and Agents Developer (AI-103). Je suis specialise dans les LLM, les pipelines RAG et les agents LangGraph sur Azure, avec plus de 3 ans d\'experience en production.',
      badge1: 'Certification Microsoft: Azure AI Apps and Agents Developer Associate (AI-103)',
      badge2: 'DeepLearning.AI: Agentic AI',
